...
const props = defineProps({
  ...
  master_type_pihak_lain_choosed: {
    type: Object,
    default: () => ([]),
  },
})
...
const removePrefixCode = () => {

    let code_origin = props.master_pihak_lain.code.split("-");
    let code_filtered = '';
    if(code_origin.length > 1){
        code_filtered = code_origin[1];
    } else {
        code_filtered = props.master_pihak_lain.code;
    }

    form.code = code_filtered;

    // form.master_type_pihak_lain = {
    //     id: props.master_type_pihak_lain_choosed.id,
    //     code: props.master_type_pihak_lain_choosed.code,
    //     name: props.master_type_pihak_lain_choosed.name,
    //     is_active: props.master_type_pihak_lain_choosed.is_active,
    //     user_id: props.master_type_pihak_lain_choosed.user_id,
    //     created_at: props.master_type_pihak_lain_choosed.created_at,
    //     updated_at: props.master_type_pihak_lain_choosed.updated_at,
    // }
}
...
const form = reactive({
  ...
  master_type_pihak_lain: props.master_type_pihak_lain_choosed ? props.master_type_pihak_lain_choosed : '',
