      ...
      <CardBox class="mb-6" has-table>
        <div class="m-5">
          ...
          <div class="mt-5 overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <tbody >
                <tr v-for="(role, index) in roles" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td>{{ role.id }}</td>
                    <td>{{ role.name }}</td>
                    <td>
                        <Link
                                :href="route('role.editt',role.id)"
