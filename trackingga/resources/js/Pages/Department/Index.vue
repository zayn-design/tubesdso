...
const createPage = () => {
    router.get(route('department.create'));
}
    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            ...
            <CardBox class="mb-6" has-table>
                <div class="m-5">
                    <BaseButtons>
                        <BaseButton @click="createPage()" color="info" label="Tambah department" :icon="mdiPlus" />
                    </BaseButtons>
                            ...
                            <tbody>
                                <tr v-for="(data, index) in datas" :key="index"
                                    ...
                                    <td data-label="company_name" class="px-6 py-4">
                                        {{ data.companyName }}
                                        <!-- <span v-for="(company_name, index) in company_datas" :key="index">
                            <span v-if="data.company_id == company_name.id">
                                {{ company_name.name }}
                            </span>
                         </span> -->
                                    </td>
