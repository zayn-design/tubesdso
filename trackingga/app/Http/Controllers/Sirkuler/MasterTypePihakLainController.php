...
class MasterTypePihakLainController extends Controller
{

    public function __construct()
    {
        $this->middleware('can:master_type_pihak_lain list', ['only' => ['index', 'show']]);
        $this->middleware('can:master_type_pihak_lain create', ['only' => ['create', 'store']]);
        $this->middleware('can:master_type_pihak_lain edit', ['only' => ['edit', 'update']]);
        $this->middleware('can:master_type_pihak_lain delete', ['only' => ['destroy']]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $new_master_pihak_lain->code = $request->code;
        $new_master_pihak_lain->name = $request->name;
